...
본 시스템은 **단일 「불법 현수막 픽셀 분류기」**가 아니라:

> **AI Municipal Vision Platform** — CCTV(업로드 MVP) 기반 도시 이상 **후보** 탐지·위험도·행정 우선순위를 제공하는 확장형 CV 플랫폼

Task 1은 **현수막 존재 탐지 + 불법 의심 후보 제안**(Risk·HITL)이며, 무단투기·도로파손·보호구역 위험 등으로 **동일 파이프라인 인터페이스**를 재사용합니다.
